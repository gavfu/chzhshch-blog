...
<img src={useBaseUrl('/img/stocks/stockschat/1.png')} style={{marginTop: "15px", width: 880}} />
</div>
:::
...
:::warning 网友配图，请自行鉴别
<div style={{textAlign: 'left'}}>
<img src={useBaseUrl('/img/stocks/stockschat/2.png')} style={{marginTop: "15px", width: 600}}/>
</div>
:::
