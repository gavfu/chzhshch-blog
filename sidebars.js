...
const { sidebar: stocksExtendedSidebar } = require('./sidebars/stocksextended');
...
const { sidebar: fundAnalysisSidebar } = require('./sidebars/fundanalysis');
